...
public:
    ...
    bool proposalIsDifferent(const nat* proposal, const nat* reference) const;

    bool proposalRespectsKnowledge(const nat* proposal, const nat* reference, const nat* referenceScore) const;

    bool plausibleSolution(const vector<nat*> *previousGuesses, const vector<nat*> *previousEvaluations, const nat* solution) const;
